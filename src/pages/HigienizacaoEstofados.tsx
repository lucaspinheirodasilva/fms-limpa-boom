...
import { CheckCircle2, Award, Droplets, Shield, Sparkles, Home } from "lucide-react";
  ...
  const services = [
    {
      ...
      description: "Limpeza profunda de sofás de todos os tamanhos e tecidos. Removemos manchas, odores e ácaros, devolvendo a beleza e higiene do seu estofado."
    },
    {
      title: "Limpeza de Poltronas e Cadeiras",
      description: "Higienização completa de poltronas, cadeiras de jantar e escritório. Ideal para residências e empresas que buscam ambientes mais saudáveis."
    },
    {
      title: "Higienização de Puffs e Bancos",
      description: "Limpeza especializada para puffs, bancos estofados e outros móveis. Técnicas que preservam o tecido e eliminam sujeiras profundas."
    },
    {
      title: "Impermeabilização de Estofados",
      description: "Proteção extra para seus estofados. A impermeabilização cria uma barreira contra líquidos e facilita a limpeza do dia a dia."
    }
  ];
      ...
      <main className="min-h-screen">
        ...
        <section className="relative min-h-[70vh] sm:min-h-[80vh] flex items-center overflow-hidden pt-16 sm:pt-20">
          <div className="absolute inset-0 bg-cover bg-center" style={{
            backgroundImage: `url(${upholsteryImg})`
          }}>
          ...
          <div className="container relative z-10 mx-auto px-4 py-12 sm:py-16 md:py-20">
            <div className="max-w-4xl">
              <div className="mb-4 sm:mb-6 inline-flex items-center gap-2 sm:gap-3 rounded-full bg-accent/20 backdrop-blur-sm border border-accent/30 px-4 sm:px-6 py-2 sm:py-3 text-xs sm:text-sm font-semibold text-white shadow-lg">
                ...
                <span>Especialistas em Higienização de Estofados desde 1999</span>
              </div>
              
              <h1 className="mb-3 sm:mb-4 text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
                Higienização de Sofás e Estofados <span className="text-accent">em Florianópolis</span>
              </h1>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-8 sm:mb-12">
              ...
              <p className="text-sm sm:text-base md:text-lg text-muted-foreground max-w-3xl mx-auto">
                ...
                Estofados renovados com qualidade.
              </p>
            </div>
        ...
        <CTABanner 
          title="Higienização de Estofados na Grande Florianópolis"
          subtitle="Sofás, poltronas e cadeiras como novos!"
        />
