...
const Header = () => {
  ...
  const navLinks = [
    { label: "Home", href: "/" },
    { label: "Serviços", href: "#", hasSubmenu: true },
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          <Link to="/" className="flex items-center gap-2">
            ...
            <div>
              <span className="text-lg sm:text-xl font-bold text-primary">FMS</span>
              <span className="text-lg sm:text-xl font-bold text-accent ml-1">Higienizações</span>
            </div>
          </Link>
            ...
            {navLinks.map((link) => (
              link.hasSubmenu ? (
                <div key={link.label} className="relative group">
                  <button
                    className="flex items-center gap-1 text-foreground/80 hover:text-primary font-medium transition-colors text-sm py-2"
                  >
                    {link.label}
          ...
          <div className="lg:hidden py-4 border-t border-border bg-white">
            <nav className="flex flex-col gap-1">
              ...
              <button
                ...
                className="flex items-center justify-between font-medium py-3 px-4 rounded-lg text-foreground/80 hover:text-primary hover:bg-muted transition-colors text-left"
              >
                Serviços
